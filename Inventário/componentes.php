...
<h1 class="text-center">Gestão de Entrada de Equipamento - Componentes</h1>
<form method="post">
...
function exibirTabela($conexao, $tabela)
{
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo '<thead><tr><th>ID</th><th>Marca</th><th>Modelo</th><th>Série</th><th>Tipo</th><th>Descrição</th><th>Quantidade</th><th>Obs</th></th><th>Ações</th></tr></thead>';
        echo '<tbody>';
