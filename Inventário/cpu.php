...
<h1 class="text-center">Gestão de Entrada de Equipamento - CPU</h1>
<form method="post">
...
function exibirTabela($conexao, $tabela)
{
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo '<thead><tr><th>ID</th><th>Marca</th><th>Modelo</th><th>Série</th><th>Processador</th><th>Memória Ram</th><th>Armazenamento</th><th>Quantidade</th><th>Obs</th><th>Ações</th></tr></thead>';        echo '<tbody>';
